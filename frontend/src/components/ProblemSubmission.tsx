    ...
    setTimeout(() => {
      ...
      if (hasKnowledgeBaseSolution) {
        setResult({
          ...
          found: true,
          solution: {
            title: "PLC Error 4096 - Motor Controller Fault",
            description:
              "This error indicates a motor controller communication fault. Check motor connections and reset the PLC module.",
            confidence: 0.92,
            verified: true,
            lastUsed: "2024-01-15",
            tags: ["PLC", "Motor", "Error 4096"],
          },
        });
      } else {
        setResult({
          ...
          found: false,
          aiSolution: {
            title: "AI-Generated Solution for PLC Error 4096",
            description:
              ...
              <CardContent className="space-y-6">
                <div className="relative">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className={`absolute top-2 right-2 ${isListening ? "text-red-500 animate-pulse" : "text-slate-400 hover:text-blue-500"}`}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          >
                            {Math.round(result.solution.confidence * 100)}%
                            match
                          </Badge>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          >
                            {Math.round(result.aiSolution.confidence * 100)}%
                            confidence
                          </Badge>
                        </div>
                        <p className="text-slate-700 mb-4">
                          {result.aiSolution.description}
                        </p>
